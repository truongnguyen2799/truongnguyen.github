 ...
 * @author ADMIN
 */
public class AddOrderSupplier extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean check = dao.insertSupplier(newSupplier);
            if (check == true) {
                request.setAttribute("mess", "Thêm thành công");
                request.getRequestDispatcher("ListOrderSupplier").forward(request, response);
